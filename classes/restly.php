...
class Restly {
     ...
     * @return  object
     */
    public static function instance(array $curl_configs = null) {
        static $instance;
    ...
    private function init(array $config) {
        // set defaults, look for Restly globals
        $this->STRICT_REST_METHODS = defined('RESTLY_STRICT_REST_METHODS')
